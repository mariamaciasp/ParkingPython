...
print(repositorio_cliente_abonado)
servicio_cliente_abonado.modificar_datos_abonado("dni", "dni222", "Pepe", "Botella", "nuevaTarjeta", "nuevoEmail",repositorio_cliente_abonado)
print(repositorio_cliente_abonado)
print("caracola")
print(parking)
...
if(op ==1):
    servicio_arking.retirar_vehiculo("dfsadf", 1,"1234", repositorio_vehiculo)
...
abono_cliente2.fecha_cancelacion = abono_cliente2.fecha_cancelacion.replace(month=(12))
abono_cliente2.fecha_cancelacion = abono_cliente2.fecha_cancelacion.replace(day=(20))
abono_cliente2.fecha_cancelacion = abono_cliente2.fecha_cancelacion.replace(year=(2020))

print(repositorio_cliente_abonado)

servicio_cliente_abonado.modificar_abono("dni222", repositorio_abono)
print("12345")
print(repositorio_cliente_abonado)
print("aqui")
print(repositorio_abono)
servicio_cliente_abonado.baja_abono("dni222", repositorio_abono, repositorio_cliente_abonado, repositorio_facturacion, repositorio_vehiculo)
print("esaqui")
