...
servicio_cliente_abonado.dar_alta_abonado(1,"1234abc","dni","María","Macías","maria@mail.com","tarjeta","mensual","coche", repositorio_cliente_abonado, repositorio_abono, servicio_parking, repositorio_vehiculo)
...
abono_prueba = Abono(cliente_abonado_1, datetime.now(), servicio_cliente_abonado.calcular_fecha_cancelacion("mensual", datetime.now()))
...
servicio_cliente_abonado.baja_abono("dni2", repositorio_abono, repositorio_cliente_abonado)
